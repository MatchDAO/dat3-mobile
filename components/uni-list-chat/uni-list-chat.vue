...
<script>
	 ...
	 * @property {Boolean} 	clickable = [true|false] 		false
	 * @property {String} 	badgeText						
	 * @property {String}  	badgePositon = [left|right]		 right
	 * @property {String} 	link = [falsenavigateTo|redirectTo|reLaunch|switchTab] false
	 *  @value false	 	
	 ...
	 * @property {Boolean} 	avatarCircle = [true|false]		false
	 * @property {String} 	avatar							avatarCircle 
	 * @property {Array} 	avatarList 						 [{url:''}]
	 * @event {Function} 	click 							 uniListChat 
	 */
	export default {
		name: 'UniListChat',
		props: {
