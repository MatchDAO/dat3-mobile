...
class RtcEngine {
   ...
   * - On Androidthis method applies to Android 4.4 or later.
   ...
   * or replaces the microphones audio stream with the specified local or remote audio file.
   ...
   * If the watermark image to be added is in the project file, you need to change the images Type from PNG image to Data in the Xcode property; otherwise, the Agora Native SDK cannot recognize the image.
